using DukkanTek.Models;
using DukkanTek.Repository;
using DukkanTek.Repository.UnitOfWork;
...
namespace DukkanTek.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DukkanTekDbContext>(opt => opt.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
